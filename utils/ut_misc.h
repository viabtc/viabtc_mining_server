...
float bswap_f(float x);
double bswap_d(double x);
...
#  define letohf(x) (x)
#  define letohd(x) (x)
#  define htobef(x) bswap_f(x)
#  define htobed(x) bswap_d(x)
#  define beftoh(x) bswap_f(x)
#  define bedtoh(x) bswap_d(x)
# else
#  define htolef(x) bswap_f(x)
#  define htoled(x) bswap_d(x)
#  define letohf(x) bswap_f(x)
#  define letohd(x) bswap_d(x)
#  define htobef(x) (x)
#  define htobed(x) (x)
#  define beftoh(x) (x)
#  define bedtoh(x) (x)
